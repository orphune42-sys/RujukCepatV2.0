  ...
  return (
    <div id="beranda" className="flex flex-col min-h-screen">
      ...
      <section className="relative pt-32 pb-24 lg:pt-40 lg:pb-36 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-full md:w-[150%] lg:w-[120%] z-0 text-[#f0f9f3]  pointer-events-none" style={{ right: '-10%', bottom: '-10%' }}>
        ...
        <div className="absolute bottom-0 right-0 w-full md:w-[140%] lg:w-[110%] z-0 text-primary/10  pointer-events-none" style={{ right: '-5%', bottom: '-5%' }}>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-6xl relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
              ...
              <motion.h1
                className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-text  mb-6 leading-[1.15]"
                initial={{ opacity: 0, y: 40, filter: 'blur(16px)' }}
                animate={{ opacity: 1, y: 0, filter: 'blur(0px)' }}
                transition={{ duration: 1.1, delay: 0.2, ease: [0.16, 1, 0.3, 1] }}
              >
                Akses Layanan Kesehatan<br />
                <span className="text-accent ">Lebih Cepat &amp; Terpadu</span>
              </motion.h1>
