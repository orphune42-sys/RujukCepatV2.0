        ...
        <motion.div variants={slideUp} className="lg:col-span-2">
          <Card className="h-full">
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Badge variant="primary">Menunggu Konfirmasi</Badge>
            </CardHeader>
            <CardContent>
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <p className="font-medium text-gray-900 dark:text-white">Senin, 15 Okt 2026 - 09:00 WIB</p>
                    </div>
                  </div>
                </div>
                <div className="flex flex-col justify-end gap-3">
                  <Button variant="outline" className="w-full">Batalkan</Button>
                  <Button variant="primary" className="w-full">Lihat Detail</Button>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <motion.div variants={slideUp}>
          <Card className="h-full">
            ...
            <CardContent className="space-y-4">
              <div className="p-3 bg-secondary/50 dark:bg-black/20 rounded-lg flex justify-between items-center">
                <div>
                ...
                <Badge variant="warning">Tersisa 2 hari</Badge>
              </div>
              <div className="p-3 bg-secondary/50 dark:bg-black/20 rounded-lg flex justify-between items-center">
                <div>
                ...
                <Badge variant="success">Tersisa 5 hari</Badge>
              </div>
