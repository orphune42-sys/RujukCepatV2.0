...
export default function SectionWaveBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
      <div className="absolute -bottom-24 -right-[18%] w-[130%] min-w-[58rem] text-[#e7f5ea] dark:text-primary/10">
      ...
      <div className="absolute -bottom-16 -right-[10%] w-[120%] min-w-[54rem] text-primary/10 dark:text-primary/5">
        <svg viewBox="0 0 1440 600" className="w-full h-auto" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
